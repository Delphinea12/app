        ...
        <Fade bottom duration={1000} distance="20px">
          <div className="skills-text-div">
            ...
            <p className="subTitle">
              ...
              peuvent renforcer le silence autour de la souffrance psychique des
              mères.
              <br />
              <br />
              ...
              caractéristiques du post-partum (<em>Slomian et al., 2019</em>).
              <br />
              <br />
              Par ailleurs, la symptomatologie de la DPP peut parfois être
              confondue avec les manifestations normales du post-partum, telles
              que la fatigue, les troubles du sommeil ou les fluctuations
              émotionnelles, rendant son identification plus complexe.
            </p>
            ...
            <p className="subTitle">
              ...
              enfants de mères dépressives sont plus enclins à manifester des
              émotions négatives (colère, tristesse), des comportements de
              retrait, et à développer, à terme, des troubles psychologiques
              plus sévères. Des études montrent même que certains effets peuvent
              se généraliser aux interactions avec d'autres adultes (
              <em>
                <a
                  href="https://shs.cairn.info/revue-la-psychiatrie-de-l-enfant-2011-2-page-611?lang=fr&tab=cites-par"
                  target="_blank"
